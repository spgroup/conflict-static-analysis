...
public class OverridingAssignmentAnalysisLocalVariablesClassFieldConflictTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(7);    //left
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentLocalVariablesClassFieldSample", lines);
                return res;
            }
        ...
        String targetClass = "br.unb.cic.analysis.samples.OverridingAssignmentLocalVariablesClassFieldSample";
