...
public class OverridingAssignmentAnalysisObjectTwoFieldTwoConflictsTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(10);    //left
                lines.add(13);    //left
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentObjectTwoFieldsTwoConflictsSample", lines);
                return res;
            }
        ...
        String targetClass = "br.unb.cic.analysis.samples.OverridingAssignmentObjectTwoFieldsTwoConflictsSample";
