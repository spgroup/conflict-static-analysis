...
public class OverridingAssignmentAnalysisArraysClassFieldConflictTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(7);    //left
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentArraysClassFieldSample", lines);
                return res;
            }
        ...
        String targetClass = "br.unb.cic.analysis.samples.OverridingAssignmentArraysClassFieldSample";
