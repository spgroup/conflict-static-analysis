...
public class OverridingAssignmentAnalysisObjectFieldsConflictTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(10);    //left
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentObjectFieldsSample", lines);
                return res;
            }
        ...
        String targetClass = "br.unb.cic.analysis.samples.OverridingAssignmentObjectFieldsSample";
