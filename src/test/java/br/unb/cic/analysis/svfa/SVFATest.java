...
//    }
    ...
    private SVFAAnalysis configureRecursiveTest(String classNameRecursiveMethodParamOneConflictDefinition, int[] sources, int[] sinks, boolean recursive) {
        AbstractMergeConflictDefinition definition = DefinitionFactory.definition(classNameRecursiveMethodParamOneConflictDefinition, sources, sinks, true);
        String cp = "target/test-classes";
        return new SVFAInterProcedural(cp, definition);
    }
}
