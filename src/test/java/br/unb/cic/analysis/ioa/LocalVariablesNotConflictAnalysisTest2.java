...
@Ignore
public class LocalVariablesNotConflictAnalysisTest2 {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(6);
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentLocalVariablesNotConflictInterProceduralSample2", lines);
                return res;
            }
