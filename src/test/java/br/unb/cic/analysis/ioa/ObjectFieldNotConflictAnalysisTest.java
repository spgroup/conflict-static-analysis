...
@Ignore
public class ObjectFieldNotConflictAnalysisTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(7);
                res.put("br.unb.cic.analysis.samples.OverridingAssignmentObjectFieldNotConflictInterProceduralSample", lines);
                return res;
            }
