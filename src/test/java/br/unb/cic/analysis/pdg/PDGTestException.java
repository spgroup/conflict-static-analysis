...
public class PDGTestException {
    ...
    public void testPDGAnalysisIntraProcedural() {
        PDGAnalysisSemanticConflicts analysis = configureIntraTest(CLASS_NAME, new int[]{10}, new int[]{16});
        CDAnalysisSemanticConflicts cd = configureIntraTestCD(CLASS_NAME, new int[]{10}, new int[]{16});
        cd.setOmitExceptingUnitEdges(true);
        DFPAnalysisSemanticConflicts dfp = configureIntraTestDFP(CLASS_NAME, new int[]{10}, new int[]{16});
