...
public class PDGMotivating {

    public static final String CLASS_NAME = "br.unb.cic.analysis.samples.DFPMotivating";
    ...
    public void testPDGAnalysisIntraProcedural() {
        PDGAnalysisSemanticConflicts analysis = configureIntraTest(CLASS_NAME, new int[]{10}, new int[]{13, 14, 15, 16});
        CDAnalysisSemanticConflicts cd = configureIntraTestCD(CLASS_NAME, new int[]{10}, new int[]{13, 14, 15, 16});
        DFPAnalysisSemanticConflicts dfp = configureIntraTestDFP(CLASS_NAME, new int[]{10}, new int[]{13, 14, 15, 16});
