...
PLOT_SAME_METHOD_DIST =  ANALYSIS_DIR +'scenarios_same_method_dist.png'
PLOT_SAME_CLASS_DIST =  ANALYSIS_DIR +'scenarios_same_class_dist.png'
PLOT_SAME_CLASS_PIE = ANALYSIS_DIR + 'conflicts_same_class_pie.png'
PLOT_SAME_METHOD_PIE = ANALYSIS_DIR + 'conflicts_same_method_pie.png'
PLOT_DIFFERENT_CLASS_DEPTH_HIST = ANALYSIS_DIR + 'conflicts_different_class_depth_hist.png'
PLOT_DIFFERENT_METHOD_DEPTH_HIST = ANALYSIS_DIR + 'conflicts_different_method_depth_hist.png'
PLOT_MEDIAN_DEPTH =  ANALYSIS_DIR +'median_depth_per_scenario.png'
PLOT_MAX_DEPTH = ANALYSIS_DIR + 'max_depth_per_scenario.png'
PLOT_MIN_DEPTH =  ANALYSIS_DIR +'min_depth_per_scenario.png'
PLOT_MEDIAN_DIFF =  ANALYSIS_DIR +'median_diff_per_scenario.png'
